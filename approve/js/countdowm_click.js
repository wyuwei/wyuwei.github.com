...
var MARGIN_TOP = 60;
//设定截止时间
const endTime = new Date(2017,5,5,0,0,0);
...
window.onload = function (){
	...
	//圆的半径是  整个效果占屏幕的五分之四，digit中，数字占 14个像素，有一个空格，之前冒号占9个，计算最后一个数字时是93 +15为 108 可得到每个圆占的，减1 是之前在计算中使用的是(RADIUS+1);
...
function updateBalls(){
	...
	//判断小球是否还在canvas中，将超出canvas范围的小球删除，以免占用过多内存
	var cnt = 0;
	for(var i = 0; i < balls.length; i++){
